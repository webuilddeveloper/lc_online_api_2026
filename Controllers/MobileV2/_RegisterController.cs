    ...
    public class RegisterController : Controller
    {
        ...
        public ActionResult<Response> FacebookLogin([FromBody] Register value)
        {
            try
            {
                ...
                var doc = col.Find(filter).Project(c => new { c.idcard, c.code, c.username, c.password, c.category, c.imageUrl, c.firstName, c.lastName, c.lv0, c.lv1, c.lv2, c.lv3, c.lv4, c.lv0List, c.lv1List, c.lv2List, c.lv3List, c.lv4List,
                    isDF = c.status == "A" ? true : false,
                ...
                if (doc == null)
                {
                    ...
                    this.create(value);
                    var newDoc = col.Find(filter).Project(c => new { c.idcard, c.code, c.username, c.password, c.category, c.prefixName, c.firstName, c.lastName, c.imageUrl, c.email, c.phone, c.lv0, c.lv1, c.lv2, c.lv3, c.lv4, c.lv0List, c.lv1List, c.lv2List, c.lv3List, c.lv4List,
                        isDF = c.status == "A" ? true : false,
                        driverLicence = driverLicence.FirstOrDefault(c => c.isActive)
                    }).FirstOrDefault();
        ...
        public ActionResult<Response> GoogleLogin([FromBody] Register value)
        {
            try
            {
                ...
                var doc = col.Find(filter).Project(c => new { c.idcard, c.code, c.username, c.password, c.category, c.imageUrl, c.firstName, c.lastName, c.userType, c.lv0, c.lv1, c.lv2, c.lv3, c.lv4, c.lv0List, c.lv1List, c.lv2List, c.lv3List, c.lv4List,
                    isDF = c.status == "A" ? true : false,
                    driverLicence = idcard != null ? driverLicence.FirstOrDefault(c => c.isActive) : new driverLicenceInfobase()
                }).FirstOrDefault();
                ...
                if (doc == null)
                {
                    ...
                    this.create(value);
                    var newDoc = col.Find(filter).Project(c => new { c.idcard, c.code, c.username, c.password, c.category, c.prefixName, c.firstName, c.lastName, c.imageUrl, c.email, c.phone, c.userType, c.lv0, c.lv1, c.lv2, c.lv3, c.lv4, c.lv0List, c.lv1List, c.lv2List, c.lv3List, c.lv4List,
                        isDF = c.status == "A" ? true : false,
                        driverLicence = driverLicence.FirstOrDefault(c => c.isActive)
                    }).FirstOrDefault();
                    return new Response { status = "S", message = "success", objectData = newDoc };
