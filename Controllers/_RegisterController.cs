    ...
    public class RegisterController : Controller
    {
        ...
        public ActionResult<Response> Read([FromBody] Criteria value)
        {
            try
            {
                ...
                var docs = col.Find(filter).SortByDescending(o => o.docDate).ThenByDescending(o => o.updateTime).Skip(value.skip).Limit(value.limit).Project(c => new { c.code, c.isActive, c.createBy, c.createDate, c.imageUrl, c.updateBy, c.updateDate, c.createTime, c.updateTime, c.docDate, c.docTime, c.category, c.username, c.password, c.prefixName, c.firstName, c.lastName, c.phone, c.email, c.userType }).ToList();
        ...
        public ActionResult<Response> Update([FromBody] Register value)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(value.userType)) { doc["userType"] = value.userType; }
        ...
        public ActionResult<Response> menuRead([FromBody] Criteria value)
        {
            try
            {
                ...
                var docs = col.Find(filter).SortBy(o => o.sequence).Project(c => new { c.code, c.isActive, c.createBy, c.createDate, c.imageUrl, c.updateBy, c.updateDate, c.createTime, c.updateTime, c.docDate, c.docTime, c.category, c.username, c.password, c.prefixName, c.firstName, c.lastName, c.phone, c.email, c.userType }).ToList();
